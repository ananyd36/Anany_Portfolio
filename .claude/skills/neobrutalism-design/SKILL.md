...
description: >-
  Neobrutalism design system for UI work. Use when building components, layouts,
  or pages that should follow hard offset shadows, thick borders, zero-radius
  corners, and punchy saturated colors. Read module files before writing code.
---
